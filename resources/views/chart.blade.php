...
<body>
    <div class="container-fluid">
        ...
        <center><h1 style="color:#000000;">Line Chart</h1></center>
...
<script type="application/javascript">
    ...
    Highcharts.chart('chart', {
        title: {
            text: 'Neue Nutzer 2022'
        },
        subtitle: {
            text: 'Einfache Grafik'
        },
        xAxis: {
            categories: ['Januar', 'Februar', 'März', 'April', 'Mai', 'Juni', 'Juli', 'August', 'September',
                'Oktober', 'November', 'Dezember'
            ]
        },
        yAxis: {
            title: {
                text: 'Anzahl von neuen Usern'
            }
        },
        legend: {
            layout: 'vertical',
